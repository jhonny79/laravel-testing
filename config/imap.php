    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            'host'  => env('IMAP_HOST', 'smtpcorp.cantv.com.ve'),
            'port'  => env('IMAP_PORT', 110),
            'protocol'  => env('IMAP_PROTOCOL', 'pop3'), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('IMAP_ENCRYPTION', 'false'), // Supported: false, 'ssl', 'tls'
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME', 'iforense@cantv.com.ve'),
            'password' => env('IMAP_PASSWORD', 'A1s2d3f4'),
        ],
